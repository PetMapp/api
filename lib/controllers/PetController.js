...
var googleService = new GoogleService_1.default();
router.get("/location/all", authorize_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.put("/find/update", authorize_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.delete("/find/remove", authorize_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const data = req.body;
...
router.post("/find/register", authorize_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
router.get("/find/get/:id", authorize_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const user = req.user;
