...
router.get("/:id", authorize, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/create", authorize, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
router.put("/update", authorize, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.delete("/delete", authorize, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
